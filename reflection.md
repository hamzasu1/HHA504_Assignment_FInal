...
- EHR implementation - onnect to Epic/Cerner systems to retrieve patient records programmatically instead of manual chart pulls. Use Azure API Management to mediate EHR connections. This would reduce processing times.
